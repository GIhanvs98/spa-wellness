<div class="sidebar">
    ...
    <a href="{{ route('compliance') }}" class="btn btn-link w-100 {{ request()->routeIs('feedback') ? 'active' : '' }}"> Compliance</a>
    <a href="{{ route('accountSettings') }}" class="btn btn-link w-100 {{ request()->routeIs('accountSettings') ? 'active' : '' }}">Account Settings</a>
    <a href="{{ route('posts.create') }}" class="btn btn-link w-100 {{ request()->routeIs('posts') ? 'active' : '' }}">Posts</a>
